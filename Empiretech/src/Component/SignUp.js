...
function SignUp() {
  ...
  async function handlerSubmit(e) {
    ...
    try {
      ...
      await addname(emailRef.current.value, nameRef.current.value);
      history.push("/");
    } catch {
        ...
        >
          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                ref={passwordRef}
                className=" appearance-none md:mt-2 rounded-md relative block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
              ></input>
            </div>
          </div>
          <div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="index" className="font-semibold text-base text-indigo-600 hover:text-indigo-500">
