...
function Nav(props) {
  ...
  return (
    <div className="nav z-20 font-bold">
      <div className="flex flex-col justify-between items-center bg-white height z-40  shadow-xl">
        <div className="flex flex-col space-y ">
          <Link to="/Dashboard/">
            <div className="hover:bg-gray-300 px-5 py-3 flex flex-row items-center">
      ...
      <div className="bg-black height w-full opacity-40 z-30" onClick={props.setOpen}></div>
    </div>
  );
}
