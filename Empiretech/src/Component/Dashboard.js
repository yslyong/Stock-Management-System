...
import SalesRecord from "./Dashboard_Component/SalesRecord";
import SalesDetails from "./Dashboard_Component/SalesDetails";
import SalesSingle from "./Dashboard_Component/SalesSingle";
...
function DashboardNew() {
  ...
  if (userInfo.Role_Name === "Admin" || userInfo.Role_Name === "Owner") {
    routes.push(
      {
  ...
  if (userInfo.Role_Name === "Sales" || userInfo.Role_Name === "Owner") {
    routes.push(
      {
  ...
  if (userInfo.Role_Name === "Sales" || userInfo.Role_Name === "Admin" || userInfo.Role_Name === "Owner") {
    routes.push(
      {
  ...
  if (userInfo.Role_Name === "Logistic" || userInfo.Role_Name === "Owner") {
    routes.push(
      {
  ...
  return (
    <div className="Dashboard">
      ...
      <ScrollLock isActive={navOpen}>
        <div className="bg-gradient-to-t from-secondary to-primary h-full min-vh flex-1 md:px-30 lg:px-28 xl:px-60 px-5 py-5 text-justify">
          <div>
            <Switch>
