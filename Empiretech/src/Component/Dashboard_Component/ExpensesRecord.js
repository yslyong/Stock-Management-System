...
import { getExpensesTotal } from "../../Context/DbContext";
...
export default function ExpensesRecord() {
  ...
  return (
    <div className="mt-8 space-y-4 py-8 px-4 md:py-12 md:px-8 shadow-xl bg-white ring-2 rounded-lg ring-gray-400 ring-opacity-20">
      <h1 className="lg:text-4xl text-2xl text-center font-bold lg:mb-10 mb-5">Expenses</h1>
      <div className="flex flex-col">
        <div className="flex lg:ml-auto lg:mt-0 mt-14">
          <Link to="/Dashboard/ExpensesCreate">
            <button
              type="submit"
