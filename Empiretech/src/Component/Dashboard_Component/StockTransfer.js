...
import { getTransferByOutlet } from "../../Context/DbContext";
...
export default function StockTransfer() {
  ...
  useEffect(() => {
    ...
    interval = setInterval(() => {
      if (transfer === undefined) {
        getTransferByOutlet(UserInfo.Outlet_Name).then((value) => {
          setTransfer(value);
        });
      }
    }, 2000);
  ...
  return (
    <div className="mt-8 space-y-4 py-8 px-4 md:py-12 md:px-8 shadow-xl bg-white ring-2 rounded-lg ring-gray-400 ring-opacity-20">
      <h1 className="lg:text-4xl text-2xl text-center font-bold lg:mb-10 mb-5">Stock Transfer</h1>
      <div className="flex flex-col">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex lg:flex-row  flex-col items-baseline">
            ...
            <div className="flex lg:ml-auto lg:mt-0 mt-14">
      ...
      <div>
        <h1 className="lg:text-2xl text-lg text-center font-bold mt-5 mb-5">Stock Transfer List</h1>
